...
- `initial_price`: 제품의 초기 가격
- `final_price`: 현재 가격 또는 할인된 가격
- `currency`: 제품 가격에 사용되는 통화
- `availability`: 제품 재고 상태(예: 재고 있음 또는 품절)
- `reviews_count`: 제품이 받은 리뷰 수
- `rating`: 제품에 대한 고객 평점
- `categories`: 제품 카테고리 또는 분류
- `asin`: 각 제품의 고유 식별자
- `seller_name`: 제품을 판매하는 판매자 이름
- `brand`: 제품의 브랜드명
- `images_count`: 제품에 사용 가능한 이미지 수
- `image_url`: 메인 제품 이미지의 URL
- `url`: 제품 페이지로의 직접 링크
- `delivery`: 예상 배송 시간 또는 비용과 같은 배송 관련 정보
- `features`: 제품 특징 또는 사양 목록
...
- [eBay Dataset](https://brightdata.co.kr/products/datasets/ebay)
- [Zara Dataset](https://brightdata.co.kr/products/datasets/zara)
- [Home Depot Dataset](https://brightdata.co.kr/products/datasets/home-depot)
...
- **Once**, **Daily**, **Weekly**, **Monthly**, **Quarterly**, 또는 **Custom intervals**
...
### 2. 경쟁 가격 전략
경쟁사의 가격, 할인, 프로모션을 모니터링하여 동적 가격 책정 전략을 구현하고 시장에서 경쟁 우위를 유지할 수 있습니다.

### 3. 소비자 감성 분석
리뷰, 평점, 피드백을 분석하여 특정 제품 또는 카테고리에 대한 고객 감성을 이해하고 제공 서비스를 개선할 수 있습니다.
...
- [Target Scraper](https://brightdata.co.kr/products/web-scraper/target)
- [eBay Scraper](https://brightdata.co.kr/products/web-scraper/ebay)
- [Zara Scraper](https://brightdata.co.kr/products/web-scraper/zara)
- [Home Depot Scraper](https://brightdata.co.kr/products/web-scraper/homedepot)
